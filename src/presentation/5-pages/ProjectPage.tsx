  ...
  return (
    <BaseLayout className="project">
      <div className="mb-6">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-stone-200 hover:bg-stone-300 transition-colors shadow font-semibold text-stone-700 text-base"
          tabIndex={0}
        >
      ...
      <h1 className="mb-10 text-5xl md:text-6xl font-heading font-extrabold text-stone-900">
        {project.name}
      </h1>
