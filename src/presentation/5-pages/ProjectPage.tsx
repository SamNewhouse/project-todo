    ...
    <BaseLayout className="project">
      <div className="mb-6 px-3 sm:px-0">
        ...
        >
          ...
          <span className="block sm:inline text-base sm:text-base">Back to Home</span>
        </Link>
      </div>
      <h1 className="mb-10 text-4xl sm:text-5xl md:text-6xl font-heading font-extrabold text-stone-900 px-3 sm:px-0 text-left">
        {project.name}
      </h1>
      <div className="w-full max-w-full sm:max-w-5xl mx-auto px-3 sm:px-0">
